...
def get_checkpoint_path(time_horizon: int) -> str:
    if time_horizon == 60:
        ...
        return "heckpoints/salto_down/salto_down_unet_det_240/det/UNet_IN3_F32_SC0_BS_8_TH240_E9_BVM0_08_D2025-06-11_10:10.pt"
    elif time_horizon == 300:
        return "heckpoints/salto_down/salto_down_unet_det_300/det/UNet_IN3_F32_SC0_BS_8_TH300_E9_BVM0_09_D2025-06-11_07:07.pt"
    else:
