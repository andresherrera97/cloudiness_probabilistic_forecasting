...
class Colors:
    ...
    palette = {
        "grays": {"silver": "#BDC3C7", "asbestos": "#7F8C8D", "concrete": "#95A5A6"},
        # 'whites' : {
        #     'clouds' : '#ECF0F1',
        # },
        "oranges": {
        ...
        "purples": {"wisteria": "#8E44AD", "amethyst": "#9B59B6"},
    }
    ...
    def view_colors():
        ...
        for index, (color_name, color) in enumerate(Colors.mixed_palette.items()):
            ...
            s = color_name  # + '=' + "" + color + ""
            plt.text(0, index + 0.85, s, family="serif", fontsize=15)
    ...
    def random_color(del_subpalettes=None, use_subpalettes=None):
        ...
        # case 2: use only use_subpaletes
            ...
            palettes = [
                Colors.palette[subpalette].items() for subpalette in use_subpalettes
            ]
        ...
        # case 3: dont use del_subpalettes
            ...
            new_use_subpalettes = [
                palette_item
                for palette_item in new_use_subpalettes
                if palette_item not in del_subpalettes
            ]
            palettes = [
                Colors.palette[subpalette].items() for subpalette in new_use_subpalettes
            ]
        ...
        # case 4: raise error
            ...
            raise ValueError(
                "use_subpalettes and del_subpalettes cannot be used simultaneously."
            )
