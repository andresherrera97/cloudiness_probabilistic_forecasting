...
from src import data, model, model_training
from src.lib import utils
from src.data import MontevideoFoldersDataset
from src.models.unet import UNet, UNet2
from src.models.unet_advanced import R2U_Net, AttU_Net, NestedUNet
...
for lr in grid_search:
  ...
  if not args.retrain:
    model.apply(model_training.weights_init)  
    checkpoint = False
  ...
  if args.writer:  
  	...
  	writer = None
  print(model_name)
  TRAIN_LOSS, VAL_MAE_LOSS, VAL_MSE_LOSS, VAL_SSIM_LOSS = model_training.train_model_full(	
  	model=model,
